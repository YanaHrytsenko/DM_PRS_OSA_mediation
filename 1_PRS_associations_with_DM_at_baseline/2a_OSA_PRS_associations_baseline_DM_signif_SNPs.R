...
OSA_PRS_bmi_UNadj <- fread("/Data/OSA_PRS/computed_OSA_PRS_sign_SNPs_only/bmi_UNadj/PRS_OSA_unadj_BMI.csv", header = T)
...
OSA_PRS_bmi_adj <- fread("/Data/OSA_PRS/computed_OSA_PRS_sign_SNPs_only/bmi_adj/PRS_OSA_adj_BMI.csv", header = T)
...
strata <- c("All","Mild_OSA", "Mild_severe_OSA")
...
write.csv(res, file = "/Results/assoc_OSA_PRS_baseline_DM_signif_SNPs.csv")
