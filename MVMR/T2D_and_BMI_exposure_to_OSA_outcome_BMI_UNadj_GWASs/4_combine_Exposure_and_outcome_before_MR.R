...
base_path <- "/Users/yana/Library/CloudStorage/OneDrive-BethIsraelLaheyHealth/2022_diabetes_PRS_interaction_sleep/Data/post_processed_data_for_MR_analysyis/T2D_and_BMI_exposure_to_OSA_outcome_BMI_UNadj_GWASs/"
...
exposure_file <- paste0("Exposure_T2D_BMI_distinct_SNPs_filtered_by_p_",threshold,"_clumped.csv")
output_file_exposure <- paste0("Exposure_T2D_BMI_distinct_SNPs_filtered_by_p_",threshold,"_clumped_clean_columns.csv")
...
outcome_file <- "/Users/yana/Library/CloudStorage/OneDrive-BethIsraelLaheyHealth/2022_diabetes_PRS_interaction_sleep/Data/post_processed_data_for_MR_analysyis/T2D_BMI_UNadj_to_OSA_BMI_UNadj/Outcome_OSA_BMI_UNadj_distinct_SNPs_sub.csv"
output_file <- "Outcome_GWAS_after_clump_sub_to_Exposure_SNPs.csv"
output_path <- paste0(base_path, p_value_dir, output_file)

unique_SNPs_path <- paste0("/Users/yana/Library/CloudStorage/OneDrive-BethIsraelLaheyHealth/2022_diabetes_PRS_interaction_sleep/Data/post_processed_data_for_MR_analysyis/T2D_and_BMI_exposure_to_OSA_outcome_BMI_UNadj_GWASs/SNPs_filtered_by_p/",clump_threshold_path,"Unique_rsIDs_instruments_T2DM_BMI.csv")
...
Outcome_GWAS$beta <- log(Outcome_GWAS$OR)

#subset to columns we need
Outcome_GWAS_reordered <- Outcome_GWAS[,c("A1","A2","EAF", "OR_se","PValue", "rsID","beta")]
Outcome_GWAS_reordered$outcome <- "OSA"
Outcome_GWAS_reordered$id.outcome <- "OSA"

#reorder
Outcome_GWAS_reordered <- Outcome_GWAS_reordered[,c("rsID","beta", "OR_se", "A1", "A2", "EAF", "PValue", "id.outcome", "outcome")]
