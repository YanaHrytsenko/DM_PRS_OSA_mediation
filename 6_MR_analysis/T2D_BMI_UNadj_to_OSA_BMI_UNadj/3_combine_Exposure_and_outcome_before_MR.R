...
base_path <- "/T2D_BMI_UNadj_to_OSA_BMI_UNadj/"
...
exposure_file <- "Exposure_T2D_BMI_UNadj_distinct_SNPs_filtered_by_p_5_times_10_to_negative_8_clumped.csv"
...
outcome_file <- "Outcome_OSA_BMI_UNadj_distinct_SNPs_sub.csv"
...
#only select columns we need
Outcome_GWAS_sub <- Outcome_GWAS[, c("rsID", "A1", "A2", "EAF", "OR", "OR_se")] #note, now OR is Beta because we took log(OR)
