...
exposure_outcome <- "T2D_BMI_adj_to_OSA_BMI_adj"

path_to_dir <- "/T2D_BMI_adj_to_OSA_BMI_adj/SNPs_filtered_by_p/"
...
output_path <- "/Results/MR_analysis_results/T2D_BMI_adj_to_OSA_BMI_adj/"
...
head(harmonized_Exposure_and_Outcome_GWASs)
